...
// Rounds played on a map (Default: 15)
ROUNDS_PER_MAP = 15
...
// Determains if players should be team swapped even if points are 0 for each team. [0 = No, 1 = Yes] (Default: 1)
SWAP_TEAMS_POINTS_ZERO = 1
